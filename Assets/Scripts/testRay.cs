...
{
    [Header("Ray Settings")] public Transform rayOrigin;

    public float rayLength = 10f;
    public LayerMask detectionLayer;
    public Color rayColor = Color.red;

    [Header("Target Settings")] public Transform objectToRotate; // The object that will face the point
    ...
    private void Update()
    {
        ...
        if (objectToRotate != null) RotateToFacePoint(targetPoint);
        if (visualizer != null) visualizer.position = targetPoint;
    ...
    private void RotateToFacePoint(Vector3 targetPoint)
    {
        ...
        var direction = targetPoint - objectToRotate.position;
