...
namespace EnemiesScript.Melee
{
    public class MeleeEnemy : Enemy
    {
        ...
        {
            if (_atk) return;
            if (_agent.isTraining) _agent.OnAttack();
        ...
        {
            if (_agent.isTraining) _agent.OnHurt();
        }
        ...
        {
            if (_agent.isTraining) _agent.OnAttackLanded();
        }

        protected override void OnKilledTarget()
        {
            if (_agent.isTraining) _agent.OnKilledTarget();
        }
