...
{
    [SerializeField] private MeleeEnemyAgent enemyAgent;
    ...
    private void OnGUI()
    {
        string debugEpisode = "Episode: " + enemyAgent.currentEpisode + " - Step: " + enemyAgent.StepCount;
        string debugReward = "Reward: " + enemyAgent.cumulativeReward.ToString(CultureInfo.InvariantCulture);
    
        // Select style based on reward value
        GUIStyle rewardStyle = enemyAgent.cumulativeReward < 0f ? _negativeStyle : _positiveStyle;
